...
async function auditSitemap() {
  ...
  const requiredLocs = [
    ...
    "/en/blog/free-ai-video-generator-without-watermark",
    "/zh/blog/free-ai-video-generator-without-watermark",
    "/en/blog/markdown-to-image-for-linkedin-posts",
    "/zh/blog/markdown-to-image-for-linkedin-posts",
    "/en/blog/instagram-caption-generator-workflow",
    "/zh/blog/instagram-caption-generator-workflow",
...
async function auditPages() {
  const pages = [
    ...
    {
      path: "/en/blog/free-ai-video-generator-without-watermark",
      titleIncludes: "Free AI Video Generator Without Watermark",
      descriptionIncludes: "watermark expectations",
      canonical: expectedUrl("/en/blog/free-ai-video-generator-without-watermark"),
      schemas: ["BlogPosting", "BreadcrumbList"],
      visibleText: ["Start with one clear shot", "Understand what “without watermark” really means", "Final publishing checklist"],
    },
    {
      path: "/en/blog/markdown-to-image-for-linkedin-posts",
      titleIncludes: "Markdown to Image for LinkedIn Posts",
      descriptionIncludes: "LinkedIn posts",
      canonical: expectedUrl("/en/blog/markdown-to-image-for-linkedin-posts"),
      schemas: ["BlogPosting", "BreadcrumbList"],
      visibleText: ["Choose one job for the card", "Make the card readable on mobile", "Export and review"],
    },
    {
      path: "/en/blog/instagram-caption-generator-workflow",
      titleIncludes: "Instagram Caption Generator Workflow",
      descriptionIncludes: "Instagram caption generator workflow",
      canonical: expectedUrl("/en/blog/instagram-caption-generator-workflow"),
      schemas: ["BlogPosting", "BreadcrumbList"],
      visibleText: ["Start with the job of the post", "Ask for a hook and caption", "Final caption checklist"],
    },
    {
    ...
    {
      path: "/zh/blog/free-ai-video-generator-without-watermark",
      titleIncludes: "免费无水印 AI 视频生成器",
      descriptionIncludes: "检查水印",
      canonical: expectedUrl("/zh/blog/free-ai-video-generator-without-watermark"),
      schemas: ["BlogPosting", "BreadcrumbList"],
      visibleText: ["先写一个清晰镜头", "理解“无水印”的实际含义", "发布前最后检查"],
    },
    {
      path: "/zh/blog/markdown-to-image-for-linkedin-posts",
      titleIncludes: "Markdown 转图片用于 LinkedIn 帖子",
      descriptionIncludes: "LinkedIn",
      canonical: expectedUrl("/zh/blog/markdown-to-image-for-linkedin-posts"),
      schemas: ["BlogPosting", "BreadcrumbList"],
      visibleText: ["先确定图片卡片的任务", "保证手机端可读", "导出前检查"],
    },
    {
      path: "/zh/blog/instagram-caption-generator-workflow",
      titleIncludes: "Instagram 文案生成器工作流",
      descriptionIncludes: "Instagram 文案生成器工作流",
      canonical: expectedUrl("/zh/blog/instagram-caption-generator-workflow"),
      schemas: ["BlogPosting", "BreadcrumbList"],
      visibleText: ["先确定这条帖子的任务", "同时生成开头和正文", "发布前检查"],
    },
  ];
